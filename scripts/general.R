...
"
  ...
  tab_header(
    ...
    subtitle = md(glue("<span style='font-weight:400;color:#8C8C8C;fon t-size:23px'>Líderes En la General TOP20 en el SuperManager 25/26 hasta la jornada 34</span>"))
  ) %>%
  tab_source_note(
  ...
  gtsave(paste0("png/General_jor_", jornada, ".png"), vwidth = 3000, vheight = 1500, expand = 200)
