...
"
  ...
  tab_header(
    title = md("<div style='line-height:134px;vertical-align:middle;text-align:left;font-weight:600;font-size:64px'>
               ...
               <span style='text-align:left;'>CLASIFICACIÓN DE NAVIDAD</div>"),
    subtitle = md(glue("<span style='font-weight:400;fon t-size:25px'>Lideres En la General TOP20 en el SUPERMANAGER DE NAVIDAD D25/26 hasta la jornada {jornada_navidad}</span>"))
  ) %>%
  tab_source_note(
